...
export const InternationalTours: React.FC = () => {
  ...
  const displayPackages = useMemo(() => {
    ...
    return [{
      ...
      duration: activeDestination.duration || '5 Days / 4 Nights',
      price: activeDestination.price || 29999,
      discountPrice: Math.round((activeDestination.price || 29999) * 1.25),
  ...
  return (
    <div className="relative min-h-screen bg-slate-50/50 pb-20">
      <PageHero
        ...
        backgroundImage={iternationalHeroImg}
        targetAnchor="intl-content"
        buttonText="Explore Global Packages"
      />
