...
import domesticHeroImg from '../assets/domesticheroimg.webp';
...
- *Travelers*: ${bookingFormData.total_travelers} Travelers`;
  ...
  const domesticKeywords = "Kashmir tour package, Dal Lake Shikara ride tour, Gulmarg Gondola package, Kerala tour package, Alleppey houseboat stay booking, Munnar tea garden tour, Ooty trip package, Kodaikanal holiday package, Goa tour package with water sports, Andaman tour package Havelock, Rajasthan heritage tour package, Himachal tour package, Leh Ladakh road trip package, Manali Solang Valley tour, Coorg tea estate tour, Pondicherry French colony tour, Wayanad cave exploration package, Yercaud lake trip, Heaven11 Holidays, domestic tour packages";

  const seoTitle = activeDestination
    ? `${activeDestination.name} Tour Packages | Heaven11 Holidays`
    : "Domestic Tour Packages | Explore India | Heaven11 Holidays";
  ...
  const seoDescription = activeDestination
    ...
    : "Explore the incredible beauty of India. Meticulously designed tour packages to Kashmir, Kerala, Ooty, Goa, Andaman, Himachal, and more.";

  const seoKeywords = activeDestination
    ? `${activeDestination.name} tour package, ${activeDestination.name} trip, ${activeDestination.name} travel plan, ${domesticKeywords}`
    : domesticKeywords;
  ...
  const seoSchema = activeDestination
    ? {
        ...
        "@graph": [
          {
            "@type": "TouristTrip",
            "@id": `https://heaven11holidays.in/domestic-tours?dest=${activeDestination.id}#trip`,
            ...
            "offers": {
              ...
              "url": `https://heaven11holidays.in/domestic-tours?dest=${activeDestination.id}`
            },
            "itinerary": {
              "@type": "ItemList",
          ...
          {
            "@type": "BreadcrumbList",
            "@id": `https://heaven11holidays.in/domestic-tours?dest=${activeDestination.id}#breadcrumb`,
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
              ...
              },
              {
                ...
                "position": 2,
                "name": "Domestic Tours",
                "item": "https://heaven11holidays.in/domestic-tours"
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": activeDestination.name,
                "item": `https://heaven11holidays.in/domestic-tours?dest=${activeDestination.id}`
              }
            ]
          }
        ]
    ...
    : {
        ...
        "@graph": [
          {
            "@type": "WebPage",
            "@id": "https://heaven11holidays.in/domestic-tours#webpage",
            "url": "https://heaven11holidays.in/domestic-tours",
            "name": "Domestic Tour Packages | Explore India | Heaven11 Holidays",
            "description": "Discover custom domestic tour packages across India. Plan holiday packages to Kashmir, Kerala, Ooty, Goa, Andaman, and more.",
            "isPartOf": {
          ...
          {
            "@type": "BreadcrumbList",
            "@id": "https://heaven11holidays.in/domestic-tours#breadcrumb",
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
