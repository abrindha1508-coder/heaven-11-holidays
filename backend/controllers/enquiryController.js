...
const submitEnquiry = async (req, res) => {
  try {
    const { name, phone, date, packageId, packageTitle, total_travelers } = req.body;
    ...
    const queryText = `
      INSERT INTO enquiries (name, phone, travel_date, package_id, package_title, total_travelers)
      VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING *
    `;
    const values = [
