    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          animate={{ 
            opacity: 1.0, // Fully opaque for natural scenery colors
            scale: 1.15,
            rotate: 0.5,
            x: mousePosition.x,
            y: mousePosition.y
          ...
          transition={{
            ...
            rotate: { duration: 8, ease: "easeOut" },
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/55 via-black/35 to-black/60 z-1 pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col justify-between h-full pt-28 pb-12">
        {/* Empty flex spacer for centering content */}
        <div className="flex-1" />

        {/* Hero Headlines */}
        <div className="max-w-4xl mx-auto space-y-6 md:space-y-8 select-none">
          ...
          <div className="overflow-hidden py-1">
            <motion.h1 
              ...
              className="font-display text-4xl sm:text-6xl md:text-7xl font-black text-white tracking-tight uppercase leading-[1.1] drop-shadow-[0_4px_12px_rgba(0,0,0,0.85)] drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
            >
              {title}
            </motion.h1>
          </div>
          ...
          >
            <p className="text-xs sm:text-sm md:text-base text-white/95 font-semibold leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              {description}
            </p>
          </motion.div>
